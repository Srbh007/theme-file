...
$slideHoz = isset($nasa_opt['product_thumbs_style']) && $nasa_opt['product_thumbs_style'] === 'hoz' ? true : false;
    ...
    <div class="nasa-row nasa-product-details-page modern nasa-layout-modern-2">
        <div<?php echo !empty($main_attrs) ? ' ' . implode(' ', $main_attrs) : ''; ?>>
            <div class="focus-info"<?php echo $style_focus; ?>>
                <div class="row">
                    <div class="<?php echo $slideHoz ? 'large-6' : 'large-7';?> small-12 columns product-gallery rtl-right padding-right-50 mobile-padding-right-10 rtl-padding-right-10 rtl-padding-left-50 rtl-mobile-padding-left-10"> 
                        <?php do_action('woocommerce_before_single_product_summary'); ?>
                    </div>

                    <div class="<?php echo $slideHoz ? 'large-6' : 'large-5';?> small-12 columns product-info text-center summary entry-summary rtl-left">
